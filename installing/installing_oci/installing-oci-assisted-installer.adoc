...
include::modules/installing-oci-ai-uploading-discovery-iso.adoc[leveloffset=+1]

// Creating a pre-authenticated request URL
include::modules/installing-oci-ai-creating-pre-authenticated-request.adoc[leveloffset=+1]
